...
export const ARABIC_DUAS = [
  "اللهم لا سهل إلا ما جعلته سهلا، وأنت تجعل الصعب إن شئت سهلا",
  "ربّ اشرح لي صدري ويسّر لي أمري",
  "اللهم ألهمني الصواب ووفقني للحق",
  "اللهم زدني علماً وفهماً وحكمةً",
  "اللهم يسّر لي ولا تعسّر عليّ",
  "اللهم بارك لي في وقتي وجهدي",
  "اللهم سدد قولي وعملي",
  "اللهم قوني على فهم ما أدرُسُ",
  "اللهم ذكرني ما نسيت وعلّمني ما جهلت",
  "ربّ زدني علماً",
  "اللهم اكشف عني القلق واملأ قلبي طمأنينة",
  "اللهم اجعل هذا الامتحان سهلاً ميسّراً",
  "اللهم وفقني في امتحاني وبارك لي في نتائجي",
  "اللهم اجعلني من الناجحين والمتفوقين",
  "اللهم امنحني الهدوء والتركيز"
];
