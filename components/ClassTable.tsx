...
const ClassTable: React.FC<ClassTableProps> = ({ classes }) => {
  ...
  return (
    <div className="modern-card overflow-hidden !border-exam-primary/20 shadow-sm">
      <div className="px-6 py-4 border-b border-exam-primary/10 bg-exam-primary/5 flex items-center gap-2">
          ...
          {classes.map((cls, index) => (
            ...
            >
              ...
              <td className="py-4 px-6 text-right">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-exam-surfaceAlt text-exam-textMuted text-sm font-medium border border-exam-border">
                  <Clock size={14} />
